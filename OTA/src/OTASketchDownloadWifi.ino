...
{
  const char *SERVER = "github.com";                                                       // Set your correct hostname
  const unsigned short SERVER_PORT = 80;                                                   // Commonly 80 (HTTP) | 443 (HTTPS)
  const char *PATH = "/diyPresso/diyPresso-One/releases/download/v1.6.0-dev/firmware.bin"; // Set the URI to the .bin firmware
